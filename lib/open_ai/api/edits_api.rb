...
module OpenAI
  class EditsApi
    ...
    def create_edit(body, opts = {})
      data, _status_code, _headers = create_edit_with_http_info(body, opts)
      data
    end
    ...
    def create_edit_with_http_info(body, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: EditsApi.create_edit ...'
      end
      # verify the required parameter 'body' is set
      if @api_client.config.client_side_validation && body.nil?
        fail ArgumentError, "Missing the required parameter 'body' when calling EditsApi.create_edit"
      end
      # resource path
      ...
      return_type = opts[:return_type] || 'CreateEditResponse' 
