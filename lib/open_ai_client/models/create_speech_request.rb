  ...
  class CreateSpeechRequest
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `OpenAIClient::CreateSpeechRequest` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `OpenAIClient::CreateSpeechRequest`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
    ...
    def valid?
      ...
      voice_validator = EnumAttributeValidator.new('Object', ['alloy', 'echo', 'fable', 'onyx', 'nova', 'shimmer'])
      return false unless voice_validator.valid?(@voice)
      response_format_validator = EnumAttributeValidator.new('Object', ['mp3', 'opus', 'aac', 'flac'])
    ...
    def voice=(voice)
      validator = EnumAttributeValidator.new('Object', ['alloy', 'echo', 'fable', 'onyx', 'nova', 'shimmer'])
    ...
    def response_format=(response_format)
      validator = EnumAttributeValidator.new('Object', ['mp3', 'opus', 'aac', 'flac'])
