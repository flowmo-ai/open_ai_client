...
module OpenAIClient
  class CreateSpeechRequest
    ...
    def valid?
      ...
      voice_validator = EnumAttributeValidator.new('Object', ['alloy', 'ash', 'coral', 'echo', 'fable', 'onyx', 'nova', 'sage', 'shimmer'])
    ...
    def voice=(voice)
      validator = EnumAttributeValidator.new('Object', ['alloy', 'ash', 'coral', 'echo', 'fable', 'onyx', 'nova', 'sage', 'shimmer'])
