...
module OpenAIClient
  ...
  class OpenAIFile
    ...
    def valid?
      ...
      purpose_validator = EnumAttributeValidator.new('Object', ['assistants', 'assistants_output', 'batch', 'batch_output', 'fine-tune', 'fine-tune-results', 'vision'])
    ...
    def purpose=(purpose)
      validator = EnumAttributeValidator.new('Object', ['assistants', 'assistants_output', 'batch', 'batch_output', 'fine-tune', 'fine-tune-results', 'vision'])
