  ...
  class CreateImageRequest
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `OpenAIClient::CreateImageRequest` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `OpenAIClient::CreateImageRequest`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
    ...
    def valid?
      ...
      quality_validator = EnumAttributeValidator.new('Object', ['standard', 'hd'])
      ...
      size_validator = EnumAttributeValidator.new('Object', ['256x256', '512x512', '1024x1024', '1792x1024', '1024x1792'])
    ...
    def quality=(quality)
      validator = EnumAttributeValidator.new('Object', ['standard', 'hd'])
    ...
    def size=(size)
      validator = EnumAttributeValidator.new('Object', ['256x256', '512x512', '1024x1024', '1792x1024', '1024x1792'])
