...
module OpenAIClient
  class FineTuningApi
    ...
    def list_fine_tuning_job_checkpoints_with_http_info(fine_tuning_job_id, opts = {})
      ...
      # resource path
      local_var_path = '/fine_tuning/jobs/{fine_tuning_job_id}/checkpoints'.sub('{' + 'fine_tuning_job_id' + '}', fine_tuning_job_id.to_s)
      ...
      return_type = opts[:return_type] || 'ListFineTuningJobCheckpointsResponse' 
