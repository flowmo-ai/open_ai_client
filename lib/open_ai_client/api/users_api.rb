...
module OpenAIClient
  class UsersApi
    ...
    def delete_user_with_http_info(user_id, opts = {})
      ...
      # resource path
      local_var_path = '/organization/users/{user_id}'.sub('{' + 'user_id' + '}', user_id.to_s)
      ...
      return_type = opts[:return_type] || 'UserDeleteResponse' 
    ...
    # @option opts [Array<String>] :emails Filter by the email address of users.
    ...
    # @param [Hash] opts the optional parameters
    # @return [User]
    def modify_user(body, user_id, opts = {})
      data, _status_code, _headers = modify_user_with_http_info(body, user_id, opts)
      data
    end
    ...
    def modify_user_with_http_info(body, user_id, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: UsersApi.modify_user ...'
      end
      # verify the required parameter 'body' is set
      if @api_client.config.client_side_validation && body.nil?
        fail ArgumentError, "Missing the required parameter 'body' when calling UsersApi.modify_user"
      end
      # verify the required parameter 'user_id' is set
      if @api_client.config.client_side_validation && user_id.nil?
