...
module OpenAIClient
  class FilesApi
    ...
    def create_file_with_http_info(file, purpose, opts = {})
      ...
      # verify enum value
      if @api_client.config.client_side_validation && !['assistants', 'batch', 'fine-tune', 'vision'].include?(purpose)
        fail ArgumentError, "invalid value for 'purpose', must be one of assistants, batch, fine-tune, vision"
      end
      # resource path
