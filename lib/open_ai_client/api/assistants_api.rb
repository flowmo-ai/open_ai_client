...
module OpenAIClient
  class AssistantsApi
    ...
    def create_assistant_file(body, assistant_id, opts = {})
      data, _status_code, _headers = create_assistant_file_with_http_info(body, assistant_id, opts)
      data
    end
    ...
    def create_assistant_file_with_http_info(body, assistant_id, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: AssistantsApi.create_assistant_file ...'
      end
      # verify the required parameter 'body' is set
      if @api_client.config.client_side_validation && body.nil?
        fail ArgumentError, "Missing the required parameter 'body' when calling AssistantsApi.create_assistant_file"
      end
      ...
      # resource path
      local_var_path = '/assistants/{assistant_id}/files'.sub('{' + 'assistant_id' + '}', assistant_id.to_s)
      ...
      return_type = opts[:return_type] || 'AssistantFileObject' 
    ...
    def delete_assistant_file_with_http_info(assistant_id, file_id, opts = {})
      ...
      # resource path
      local_var_path = '/assistants/{assistant_id}/files/{file_id}'.sub('{' + 'assistant_id' + '}', assistant_id.to_s).sub('{' + 'file_id' + '}', file_id.to_s)
      ...
      return_type = opts[:return_type] || 'DeleteAssistantFileResponse' 
    ...
    def get_message_file_with_http_info(thread_id, message_id, file_id, opts = {})
      ...
      # resource path
      local_var_path = '/threads/{thread_id}/messages/{message_id}/files/{file_id}'.sub('{' + 'thread_id' + '}', thread_id.to_s).sub('{' + 'message_id' + '}', message_id.to_s).sub('{' + 'file_id' + '}', file_id.to_s)
      ...
      return_type = opts[:return_type] || 'MessageFileObject' 
    ...
    def list_assistant_files_with_http_info(assistant_id, opts = {})
      ...
      return_type = opts[:return_type] || 'ListAssistantFilesResponse' 
    ...
    def list_message_files_with_http_info(thread_id, message_id, opts = {})
      ...
      # resource path
      local_var_path = '/threads/{thread_id}/messages/{message_id}/files'.sub('{' + 'thread_id' + '}', thread_id.to_s).sub('{' + 'message_id' + '}', message_id.to_s)
      ...
      return_type = opts[:return_type] || 'ListMessageFilesResponse' 
