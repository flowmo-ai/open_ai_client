...
module OpenAIClient
  class FineTunesApi
    ...
    def cancel_fine_tune_with_http_info(fine_tune_id, opts = {})
      ...
      # resource path
      local_var_path = '/fine-tunes/{fine_tune_id}/cancel'.sub('{' + 'fine_tune_id' + '}', fine_tune_id.to_s)
      ...
      return_type = opts[:return_type] || 'FineTune' 
    ...
    # @param [Hash] opts the optional parameters
    # @return [FineTune]
    def create_fine_tune(body, opts = {})
      data, _status_code, _headers = create_fine_tune_with_http_info(body, opts)
      data
    end
    ...
    # @param [Hash] opts the optional parameters
    # @return [Array<(FineTune, Integer, Hash)>] FineTune data, response status code and response headers
    def create_fine_tune_with_http_info(body, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: FineTunesApi.create_fine_tune ...'
      end
      # verify the required parameter 'body' is set
      if @api_client.config.client_side_validation && body.nil?
        fail ArgumentError, "Missing the required parameter 'body' when calling FineTunesApi.create_fine_tune"
      end
      # resource path
    ...
    def list_fine_tune_events_with_http_info(fine_tune_id, opts = {})
      ...
      # resource path
      local_var_path = '/fine-tunes/{fine_tune_id}/events'.sub('{' + 'fine_tune_id' + '}', fine_tune_id.to_s)
      ...
      return_type = opts[:return_type] || 'ListFineTuneEventsResponse' 
    ...
    def list_fine_tunes_with_http_info(opts = {})
      ...
      return_type = opts[:return_type] || 'ListFineTunesResponse' 
    ...
    def retrieve_fine_tune_with_http_info(fine_tune_id, opts = {})
      ...
      # resource path
      local_var_path = '/fine-tunes/{fine_tune_id}'.sub('{' + 'fine_tune_id' + '}', fine_tune_id.to_s)
