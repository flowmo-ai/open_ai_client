...
# Unit tests for OpenAIClient::ProjectUserCreateRequest
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'ProjectUserCreateRequest' do
  before do
    # run before each test
    @instance = OpenAIClient::ProjectUserCreateRequest.new
  end
  ...
  describe 'test an instance of ProjectUserCreateRequest' do
    it 'should create an instance of ProjectUserCreateRequest' do
      expect(@instance).to be_instance_of(OpenAIClient::ProjectUserCreateRequest)
    end
  end
