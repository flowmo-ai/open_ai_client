...
# Unit tests for OpenAIClient::ProjectListResponse
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'ProjectListResponse' do
  before do
    # run before each test
    @instance = OpenAIClient::ProjectListResponse.new
  end
  ...
  describe 'test an instance of ProjectListResponse' do
    it 'should create an instance of ProjectListResponse' do
      expect(@instance).to be_instance_of(OpenAIClient::ProjectListResponse)
    end
  end
