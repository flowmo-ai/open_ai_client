...
# Unit tests for OpenAIClient::FineTuningJobEvent
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'FineTuningJobEvent' do
  before do
    # run before each test
    @instance = OpenAIClient::FineTuningJobEvent.new
  end
  ...
  describe 'test an instance of FineTuningJobEvent' do
    it 'should create an instance of FineTuningJobEvent' do
      expect(@instance).to be_instance_of(OpenAIClient::FineTuningJobEvent)
    end
  end
