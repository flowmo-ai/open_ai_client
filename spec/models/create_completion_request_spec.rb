...
# Unit tests for OpenAIClient::CreateCompletionRequest
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'CreateCompletionRequest' do
  before do
    # run before each test
    @instance = OpenAIClient::CreateCompletionRequest.new
  end
  ...
  describe 'test an instance of CreateCompletionRequest' do
    it 'should create an instance of CreateCompletionRequest' do
      expect(@instance).to be_instance_of(OpenAIClient::CreateCompletionRequest)
    end
  end
