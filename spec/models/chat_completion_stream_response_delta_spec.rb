...
# Unit tests for OpenAIClient::ChatCompletionStreamResponseDelta
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'ChatCompletionStreamResponseDelta' do
  before do
    # run before each test
    @instance = OpenAIClient::ChatCompletionStreamResponseDelta.new
  end
  ...
  describe 'test an instance of ChatCompletionStreamResponseDelta' do
    it 'should create an instance of ChatCompletionStreamResponseDelta' do
      expect(@instance).to be_instance_of(OpenAIClient::ChatCompletionStreamResponseDelta)
    end
  end
