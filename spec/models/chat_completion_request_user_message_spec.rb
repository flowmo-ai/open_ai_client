...
# Unit tests for OpenAIClient::ChatCompletionRequestUserMessage
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'ChatCompletionRequestUserMessage' do
  before do
    # run before each test
    @instance = OpenAIClient::ChatCompletionRequestUserMessage.new
  end
  ...
  describe 'test an instance of ChatCompletionRequestUserMessage' do
    it 'should create an instance of ChatCompletionRequestUserMessage' do
      expect(@instance).to be_instance_of(OpenAIClient::ChatCompletionRequestUserMessage)
    end
  end
