...
# Unit tests for OpenAIClient::UploadPart
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'UploadPart' do
  before do
    # run before each test
    @instance = OpenAIClient::UploadPart.new
  end
  ...
  describe 'test an instance of UploadPart' do
    it 'should create an instance of UploadPart' do
      expect(@instance).to be_instance_of(OpenAIClient::UploadPart)
    end
  end
