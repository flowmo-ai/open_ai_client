...
# Unit tests for OpenAIClient::CreateEmbeddingResponse
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'CreateEmbeddingResponse' do
  before do
    # run before each test
    @instance = OpenAIClient::CreateEmbeddingResponse.new
  end
  ...
  describe 'test an instance of CreateEmbeddingResponse' do
    it 'should create an instance of CreateEmbeddingResponse' do
      expect(@instance).to be_instance_of(OpenAIClient::CreateEmbeddingResponse)
    end
  end
