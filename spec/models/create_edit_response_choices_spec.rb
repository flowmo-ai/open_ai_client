...
# Unit tests for OpenAI::CreateEditResponseChoices
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'CreateEditResponseChoices' do
  before do
    # run before each test
    @instance = OpenAI::CreateEditResponseChoices.new
  end
  ...
  describe 'test an instance of CreateEditResponseChoices' do
    it 'should create an instance of CreateEditResponseChoices' do
      expect(@instance).to be_instance_of(OpenAI::CreateEditResponseChoices)
    end
  end
