...
# Unit tests for OpenAIClient::CreateMessageRequest
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'CreateMessageRequest' do
  before do
    # run before each test
    @instance = OpenAIClient::CreateMessageRequest.new
  end
  ...
  describe 'test an instance of CreateMessageRequest' do
    it 'should create an instance of CreateMessageRequest' do
      expect(@instance).to be_instance_of(OpenAIClient::CreateMessageRequest)
    end
  end
