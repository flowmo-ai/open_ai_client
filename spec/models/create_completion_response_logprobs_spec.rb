...
# Unit tests for OpenAI::CreateCompletionResponseLogprobs
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'CreateCompletionResponseLogprobs' do
  before do
    # run before each test
    @instance = OpenAI::CreateCompletionResponseLogprobs.new
  end
  ...
  describe 'test an instance of CreateCompletionResponseLogprobs' do
    it 'should create an instance of CreateCompletionResponseLogprobs' do
      expect(@instance).to be_instance_of(OpenAI::CreateCompletionResponseLogprobs)
    end
  end
