...
# Unit tests for OpenAIClient::ListFilesResponse
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'ListFilesResponse' do
  before do
    # run before each test
    @instance = OpenAIClient::ListFilesResponse.new
  end
  ...
  describe 'test an instance of ListFilesResponse' do
    it 'should create an instance of ListFilesResponse' do
      expect(@instance).to be_instance_of(OpenAIClient::ListFilesResponse)
    end
  end
