...
# Unit tests for OpenAIClient::RealtimeSessionCreateResponse
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'RealtimeSessionCreateResponse' do
  before do
    # run before each test
    @instance = OpenAIClient::RealtimeSessionCreateResponse.new
  end
  ...
  describe 'test an instance of RealtimeSessionCreateResponse' do
    it 'should create an instance of RealtimeSessionCreateResponse' do
      expect(@instance).to be_instance_of(OpenAIClient::RealtimeSessionCreateResponse)
    end
  end
