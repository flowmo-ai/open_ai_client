...
# Unit tests for OpenAI::CreateModerationResponseCategories
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'CreateModerationResponseCategories' do
  before do
    # run before each test
    @instance = OpenAI::CreateModerationResponseCategories.new
  end
  ...
  describe 'test an instance of CreateModerationResponseCategories' do
    it 'should create an instance of CreateModerationResponseCategories' do
      expect(@instance).to be_instance_of(OpenAI::CreateModerationResponseCategories)
    end
  end
