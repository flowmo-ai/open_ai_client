...
# Unit tests for OpenAIClient::TruncationObject
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'TruncationObject' do
  before do
    # run before each test
    @instance = OpenAIClient::TruncationObject.new
  end
  ...
  describe 'test an instance of TruncationObject' do
    it 'should create an instance of TruncationObject' do
      expect(@instance).to be_instance_of(OpenAIClient::TruncationObject)
    end
  end
