...
# Unit tests for OpenAIClient::ChatCompletionRequestMessageContentPartImageImageUrl
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'ChatCompletionRequestMessageContentPartImageImageUrl' do
  before do
    # run before each test
    @instance = OpenAIClient::ChatCompletionRequestMessageContentPartImageImageUrl.new
  end
  ...
  describe 'test an instance of ChatCompletionRequestMessageContentPartImageImageUrl' do
    it 'should create an instance of ChatCompletionRequestMessageContentPartImageImageUrl' do
      expect(@instance).to be_instance_of(OpenAIClient::ChatCompletionRequestMessageContentPartImageImageUrl)
    end
  end
