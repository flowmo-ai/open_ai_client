...
# Unit tests for OpenAIClient::CreateImageEditRequest
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'CreateImageEditRequest' do
  before do
    # run before each test
    @instance = OpenAIClient::CreateImageEditRequest.new
  end
  ...
  describe 'test an instance of CreateImageEditRequest' do
    it 'should create an instance of CreateImageEditRequest' do
      expect(@instance).to be_instance_of(OpenAIClient::CreateImageEditRequest)
    end
  end
