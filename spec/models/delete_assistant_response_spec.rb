...
# Unit tests for OpenAIClient::DeleteAssistantResponse
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'DeleteAssistantResponse' do
  before do
    # run before each test
    @instance = OpenAIClient::DeleteAssistantResponse.new
  end
  ...
  describe 'test an instance of DeleteAssistantResponse' do
    it 'should create an instance of DeleteAssistantResponse' do
      expect(@instance).to be_instance_of(OpenAIClient::DeleteAssistantResponse)
    end
  end
