...
# Unit tests for OpenAIClient::ProjectUserDeleteResponse
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'ProjectUserDeleteResponse' do
  before do
    # run before each test
    @instance = OpenAIClient::ProjectUserDeleteResponse.new
  end
  ...
  describe 'test an instance of ProjectUserDeleteResponse' do
    it 'should create an instance of ProjectUserDeleteResponse' do
      expect(@instance).to be_instance_of(OpenAIClient::ProjectUserDeleteResponse)
    end
  end
