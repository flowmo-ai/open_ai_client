...
# Unit tests for OpenAIClient::MessageDeltaContentRefusalObject
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'MessageDeltaContentRefusalObject' do
  before do
    # run before each test
    @instance = OpenAIClient::MessageDeltaContentRefusalObject.new
  end
  ...
  describe 'test an instance of MessageDeltaContentRefusalObject' do
    it 'should create an instance of MessageDeltaContentRefusalObject' do
      expect(@instance).to be_instance_of(OpenAIClient::MessageDeltaContentRefusalObject)
    end
  end
