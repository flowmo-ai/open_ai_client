...
# Unit tests for OpenAIClient::InlineResponse2002
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'InlineResponse2002' do
  before do
    # run before each test
    @instance = OpenAIClient::InlineResponse2002.new
  end
  ...
  describe 'test an instance of InlineResponse2002' do
    it 'should create an instance of InlineResponse2002' do
      expect(@instance).to be_instance_of(OpenAIClient::InlineResponse2002)
    end
  end
