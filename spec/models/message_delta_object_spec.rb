...
# Unit tests for OpenAIClient::MessageDeltaObject
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'MessageDeltaObject' do
  before do
    # run before each test
    @instance = OpenAIClient::MessageDeltaObject.new
  end
  ...
  describe 'test an instance of MessageDeltaObject' do
    it 'should create an instance of MessageDeltaObject' do
      expect(@instance).to be_instance_of(OpenAIClient::MessageDeltaObject)
    end
  end
