...
# Unit tests for OpenAIClient::RunStepDeltaStepDetailsToolCallsCodeObject
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'RunStepDeltaStepDetailsToolCallsCodeObject' do
  before do
    # run before each test
    @instance = OpenAIClient::RunStepDeltaStepDetailsToolCallsCodeObject.new
  end
  ...
  describe 'test an instance of RunStepDeltaStepDetailsToolCallsCodeObject' do
    it 'should create an instance of RunStepDeltaStepDetailsToolCallsCodeObject' do
      expect(@instance).to be_instance_of(OpenAIClient::RunStepDeltaStepDetailsToolCallsCodeObject)
    end
  end
