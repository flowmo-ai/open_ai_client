...
# Unit tests for OpenAIClient::RunStepDetailsMessageCreationObject
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'RunStepDetailsMessageCreationObject' do
  before do
    # run before each test
    @instance = OpenAIClient::RunStepDetailsMessageCreationObject.new
  end
  ...
  describe 'test an instance of RunStepDetailsMessageCreationObject' do
    it 'should create an instance of RunStepDetailsMessageCreationObject' do
      expect(@instance).to be_instance_of(OpenAIClient::RunStepDetailsMessageCreationObject)
    end
  end
