...
# Unit tests for OpenAIClient::MessageContentTextAnnotationsFileCitationObject
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'MessageContentTextAnnotationsFileCitationObject' do
  before do
    # run before each test
    @instance = OpenAIClient::MessageContentTextAnnotationsFileCitationObject.new
  end
  ...
  describe 'test an instance of MessageContentTextAnnotationsFileCitationObject' do
    it 'should create an instance of MessageContentTextAnnotationsFileCitationObject' do
      expect(@instance).to be_instance_of(OpenAIClient::MessageContentTextAnnotationsFileCitationObject)
    end
  end
