...
# Unit tests for OpenAIClient::MessageContentTextAnnotationsFileCitationObjectFileCitation
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'MessageContentTextAnnotationsFileCitationObjectFileCitation' do
  before do
    # run before each test
    @instance = OpenAIClient::MessageContentTextAnnotationsFileCitationObjectFileCitation.new
  end
  ...
  describe 'test an instance of MessageContentTextAnnotationsFileCitationObjectFileCitation' do
    it 'should create an instance of MessageContentTextAnnotationsFileCitationObjectFileCitation' do
      expect(@instance).to be_instance_of(OpenAIClient::MessageContentTextAnnotationsFileCitationObjectFileCitation)
    end
  end
