...
# Unit tests for OpenAIClient::ProjectRateLimitUpdateRequest
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'ProjectRateLimitUpdateRequest' do
  before do
    # run before each test
    @instance = OpenAIClient::ProjectRateLimitUpdateRequest.new
  end
  ...
  describe 'test an instance of ProjectRateLimitUpdateRequest' do
    it 'should create an instance of ProjectRateLimitUpdateRequest' do
      expect(@instance).to be_instance_of(OpenAIClient::ProjectRateLimitUpdateRequest)
    end
  end
