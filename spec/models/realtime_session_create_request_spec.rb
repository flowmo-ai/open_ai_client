...
# Unit tests for OpenAIClient::RealtimeSessionCreateRequest
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'RealtimeSessionCreateRequest' do
  before do
    # run before each test
    @instance = OpenAIClient::RealtimeSessionCreateRequest.new
  end
  ...
  describe 'test an instance of RealtimeSessionCreateRequest' do
    it 'should create an instance of RealtimeSessionCreateRequest' do
      expect(@instance).to be_instance_of(OpenAIClient::RealtimeSessionCreateRequest)
    end
  end
