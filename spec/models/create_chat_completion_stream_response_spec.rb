...
# Unit tests for OpenAIClient::CreateChatCompletionStreamResponse
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'CreateChatCompletionStreamResponse' do
  before do
    # run before each test
    @instance = OpenAIClient::CreateChatCompletionStreamResponse.new
  end
  ...
  describe 'test an instance of CreateChatCompletionStreamResponse' do
    it 'should create an instance of CreateChatCompletionStreamResponse' do
      expect(@instance).to be_instance_of(OpenAIClient::CreateChatCompletionStreamResponse)
    end
  end
