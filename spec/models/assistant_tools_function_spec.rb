...
# Unit tests for OpenAIClient::AssistantToolsFunction
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'AssistantToolsFunction' do
  before do
    # run before each test
    @instance = OpenAIClient::AssistantToolsFunction.new
  end
  ...
  describe 'test an instance of AssistantToolsFunction' do
    it 'should create an instance of AssistantToolsFunction' do
      expect(@instance).to be_instance_of(OpenAIClient::AssistantToolsFunction)
    end
  end
