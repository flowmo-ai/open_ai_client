# OpenAIClient::CreateFineTuningJobRequest

## Properties
Name | Type | Description | Notes
------------ | ------------- | ------------- | -------------
**model** | [**AnyOfCreateFineTuningJobRequestModel**](AnyOfCreateFineTuningJobRequestModel.md) | The name of the model to fine-tune. You can select one of the [supported models](/docs/guides/fine-tuning#which-models-can-be-fine-tuned).  | 
...
**integrations** | [**Array&lt;CreateFineTuningJobRequestIntegrations&gt;**](CreateFineTuningJobRequestIntegrations.md) | A list of integrations to enable for your fine-tuning job. | [optional] 
